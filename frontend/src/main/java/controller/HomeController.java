...
public class HomeController extends SwitchScenes{
    ...
    public void showInfoEvent() {
        try {
            system.getChildren().clear();
            system.getChildren().add(FXMLLoader.load(getClass().getResource("../view/event.fxml")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void showProfile() {
        try {
            system.getChildren().clear();
            system.getChildren().add(FXMLLoader.load(getClass().getResource("../view/profile.fxml")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
